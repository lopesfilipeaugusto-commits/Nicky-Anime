...
import { MagnifyingGlassIcon, InformationCircleIcon, HeartIcon, PlusIcon, StarIcon, XMarkIcon } from '@heroicons/react/24/outline';

function AnimeFeed({ animes, loading, onSelectAnime, onToggleFavorite, onAddToList, onLoadMore, hasMore, onSearch, onClearSearch }) {
        ...
        <div className="max-w-7xl mx-auto">
          {isSearchOpen ? (
            <form onSubmit={handleSearch} className="flex gap-2">
              ...
              />
              <button type="submit" className="px-4 py-2 rounded-lg bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
                Ir
              </button>
              <button 
                type="button" 
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    {/* Title */}
                    <h3 className="font-bold text-lg line-clamp-2 hover:text-accent transition-colors cursor-pointer"
          ...
          <div className="flex items-center justify-center py-12">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                {loading ? 'A carregar animes...' : 'Nenhum anime encontrado.'}
              </p>
            </div>
          </div>
        )}
